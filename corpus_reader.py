...
def create_penntreebank_dataset(files):
    ...
    file_list, tagged_token, total_tagged_tokens, dictionary, i , d  = initialise_variables()
...
def create_genia_dataset(files):
    ...
    """
    #initalise the variables for creating the dataset
    file_list, tagged_token, total_tagged_tokens, sentence_dict, i , d  = initialise_variables()
    ...
    for file in files:
        ...
        for sent in sents:
            ...
            tokens_modified = []
            # Tokenise the sentences into words using NLTK
            tokens = WhitespaceTokenizer().tokenize(sent)      # Example : ['====================', 'Copyright/NN', '1999/CD', 'Academic/NNP', 'Press/NNP', './.']
            ...
            for token in tokens:
                ...
                if token == "====================":
                    ...
                    tokens_modified.append(token)    # Example : ['To/TO', 'date/VB', 'no/DT', 'SOCS/NN', 'proteins/NNS', 'have/VBP']
            ...
            for token in tagged_token:
                for t in token:
                    ...
                    word_lis = []
                    tag = []
                    word_lis = t.split('/')[0:-1]  # Example : Platelet/endothelium/NN --> Platelet/endothelium --> Platelet endothelium
                    word =" ".join(word_lis)
...
def create_conll_dataset(files):
    ...
    """
    #initalise the variables for creating the dataset
    file_list, tagged_token, total_tagged_tokens, sentence_dict, i , d  = initialise_variables()  #initalise the variables for creating the dataset
    ...
    for item in range(len(dictionary)):
        for tags in dictionary[item]:
            if tags[1] == '#' or tags[1] == '$' or tags[1] == 'SYM':
                ...
                #Particle
                tags[1] = 'PART'
            elif tags[1] == 'RBR' or tags[1] == 'RBS' or tags[1] == 'RB' or tags[1] == 'WRB':
                #Adverb
                tags[1] = 'ADV'
            elif tags[1] == 'UH':
                #Interjection
